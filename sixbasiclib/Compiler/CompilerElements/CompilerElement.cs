...
namespace sixbasiclib.Compiler.CompilerElements
{
	...
	public abstract class CompilerElement
    {
        ...
        public List<byte> Processed { get; set; } = new List<byte>();
    ...
    public class Keyword : CompilerElement
    {
        ...
        public MicrosoftBasic2Token Token { get; set; } = new MicrosoftBasic2Token();
        public new string ToString()
        {
